...
var token = "xoxb-11527116646-nQ3xfsHimHqdXBHWzTKL5aRw";
var botName = "brit";

// This is the main Bot interface
var superscript = require("superscript");
var mongoose = require("mongoose");
mongoose.connect('mongodb://localhost/' + botName);
...
var cnet = require("conceptnet")({host:'127.0.0.1', user:'root', pass:'brit'});
...
options['scope'] = {slack: slack, cnet: cnet};
